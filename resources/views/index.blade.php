...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky" data-offset="500">
      <div class="container">
        <a href="#" class="navbar-brand"><span class="text-primary">Molidu</span></a>
        ...
        <div class="navbar-collapse collapse" id="navbarContent">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="btn btn-primary ml-lg-2" href="#">Subscriptions</a>
            </li>
          </ul>
        </div>
      ...
      <div class="page-banner home-banner">
        <div class="row align-items-center flex-wrap-reverse h-100">
          <div class="col-md-6 py-5 wow fadeInLeft">
            <h1 class="mb-4">Welcome To Molidu</h1>
            <p class="text-lg text-grey mb-5">Solusi Pembelajaran Daring Secara Sistematis, Edukatif dan Interaktif.”</p>
            <a href="#" class="btn btn-primary btn-split" target="_blank">Watch Video <div class="fab"><span class="mai-play"></span></div></a>
          </div>
          <div class="col-md-6 py-5 wow zoomIn">
            <div class="img-fluid text-center">
              <img src="../assets/img/teaching.svg" alt="">
            </div>
          </div>
        </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 py-3 wow fadeInRight">
          <div class="img-fluid py-3 text-center">
            <img src="../assets/img/developer.png" width="500" height="500" alt="">
          </div>
        </div>
      </div>
    </div> <!-- .container -->
  ...
  <div class="page-section">
    <div class="container">
      <div class="text-center wow fadeInUp">
        <div class="subhead">Yuk Berlangganan !</div>
    ...
    <div class="container">
      <div class="row mb-5">
        ...
        <div class="col-lg-3 py-3">
          ...
          <a href="#" class="footer-link">molidulearning@gmail.com</a>
        </div>
        <div class="col-lg-3 py-3">
          <h5>Newsletter</h5>
          <p>Dapatkan pemberitahuan terupdate dari Molidu</p>
          <form action="#">
      ...
      <p class="text-center" id="copyright">Copyright &copy; 2021. Design and develop by <a href="https://macodeid.com/" target="_blank">Molidu Team</a></p>
    </div>
  </footer>
